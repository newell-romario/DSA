...
r2_uint16               r2_deque_insert_at_back(struct  r2_deque *, void*);
r2_uint16               r2_deque_delete_at_front(struct r2_deque  *); 
r2_uint16               r2_deque_delete_at_back(struct r2_deque *);
