...
struct r2_list*     r2_list_insert_at_front(struct r2_list *, void*); 
struct r2_list*     r2_list_insert_at_back(struct r2_list *, void*); 
struct r2_list*     r2_list_insert_after(struct r2_list *, struct r2_listnode *, void *);
struct r2_list*     r2_list_insert_before(struct r2_list *, struct r2_listnode *, void *);
struct r2_list*     r2_list_delete_at_front(struct r2_list *); 
struct r2_list*     r2_list_delete_at_back(struct r2_list *);
struct r2_list*     r2_list_delete(struct r2_list *, struct r2_listnode *);
